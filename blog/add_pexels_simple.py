#!/usr/bin/env python3
"""Add Pexels images to simple blog posts"""
...
def add_pexels_image_simple(filename, topic='general'):
    """Add Pexels image to simple blog post"""
    ...
    pexels_html = f'''
    <p><img src="{image_url}" alt="Gesundheitstipp" style="width:100%; border-radius:12px; margin:20px 0;"></p>
    '''
    
    # Find the content div
    pattern = r'(<p class="meta">.*?</p>\s*<div class="content">)'
...
for filename in os.listdir(blog_dir):
    if filename.endswith('.html') and filename != 'blog.html':
        ...
        if 'aminos' in filename.lower():
            ...
            topic = 'fitness'
        elif 'mann' in filename.lower() or 'männer' in filename.lower():
            topic = 'health'
        ...
        add_pexels_image_simple(filepath, topic)
